        ...
        $(function () {
            $("button.addToCart").click(function () {
                ...
                $.getJSON("${pageScope.basePath}cartServlet","action=ajaxAddItem&id="+id,function (data) {
                    ...
                    $("#cartLastName").text(data.lastName+"已加到了您的购物车中");
                })
            })
        })
...
<div id="header">
    ...
    <span class="wel_word" style="color: #39987c">线上书城</span>
    <div>
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            <c:if test="${not empty sessionScope.cart.items}">
                ...
                <div>
                    <span id="cartLastName">${sessionScope.lastName}已加到了您的购物车中</span>
                </div>
            </c:if>
            <c:if test="${empty sessionScope.cart.items}">
            <div>
                <span style="color: red" id="cartTotalCount">当前购物车为空</span>
            </div>
            <span id="cartLastName">请浏览商品，并添加至您的购物车</span>
        </c:if>
        </div>
        ...
        <c:forEach items="${requestScope.page.items}" var="book">
            ...
            <div class="b_list">
                ...
                <div class="book_info">
                    ...
                    <div class="book_add">
                        <button id="${book.id}" name="${book.name}" class="addToCart" >加入购物车</button>
                    </div>
                </div>
            </div>
        </c:forEach>
